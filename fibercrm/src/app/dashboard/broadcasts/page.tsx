...
const SMS_TEMPLATES = [
  { label: "Invoice reminder",  body: "Hi {{name}}, your FiberCRM invoice is due. Pay via M-Pesa Paybill 174379, Acc: your invoice number. Call 0800 000 000 for help." },
  ...
  { label: "Promo offer",       body: "Hi {{name}}, upgrade to a faster FiberCRM plan this month and get your first month at 50% off! Call 0800 000 000 to upgrade." },
  { label: "Welcome new area",  body: "Hi {{name}}, FiberCRM fiber internet is now available in your area! Sign up at portal.fibercrm.co.ke or call 0800 000 000." },
];
          ...
          {["email","both"].includes(form.channel) && (
            <>
              <div>
                ...
                <input className="input" placeholder="Your April invoice from FiberCRM"

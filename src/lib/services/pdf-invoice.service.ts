...
<body>
  <div class="header">
    <div class="logo">
      ...
      <div>
        <div class="logo-name">OpsCentre</div>
  ...
  <div class="footer">
    <p>OpsCentre · Nairobi, Kenya · support@opscentre.io · 0800 000 000</p>
    <p style="margin-top:4px">Thank you for choosing OpsCentre for your internet needs.</p>
  </div>
